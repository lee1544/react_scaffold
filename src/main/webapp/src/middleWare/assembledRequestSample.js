...
let zippedRequests = {
    [ASSEMBLED_REQUESTS]: {
         ...
         */
        zip: (responses, errors) => { return responses }  // optional. a default zip function will be used if you didn't setup a zip function
    }
}
...
let transformerRequests = {
    [ASSEMBLED_REQUESTS]: {
         ...
         */
        transform: (lastResponse, lastError) => { return lastResponse }  // required
    }
}
